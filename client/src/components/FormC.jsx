            ...
            <div className="mm">
                ...
                <div className="hover">
                    ...
                    <div className="center">
                        ...
                        <form className="box-container" action="/products" method="post" encType="multipart/form-data"
                              onSubmit={handleSubmit}>
                            <h6>What Are You looking For ?</h6>
                            <FormWithMap updateLocation={updateLocation}/>
                            <div>
                                <input type="text" id="productName" placeholder="Product Name" value={data.productName}
                                       onChange={handleChange} required className='n'/>

                            </div>
                            <input type="hidden" value=""/>
                            <div>
                                <textarea id="description" placeholder="Description" onChange={handleChange}
                                          value={data.description} required className='m'/>
                            </div>
                            ...
                            <button type="submit" id="btn" className='btn' onClick={handleSubmit}>SEARCH FOR DELIVERY</button>
